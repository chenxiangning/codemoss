...
- [`2026-08-13-fix-windows-open-app-probe-console-flash`](2026-08-13-fix-windows-open-app-probe-console-flash/proposal.md) — user accepted（Windows 实机人工 QA 通过），已同步 `open-app-target-detection`；打开方式设置检测改用 `std_command` 携带 `CREATE_NO_WINDOW`，消除瞬间黑窗
