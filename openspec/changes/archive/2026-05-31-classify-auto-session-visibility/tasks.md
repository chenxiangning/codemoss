...
- [x] 4.4 Update relevant Trellis/code-level specs if implementation introduces reusable contracts outside OpenSpec; depends on implementation outcome; output: synchronized `dev-guidelines/**` guidance when required; validation: review changed spec docs.
