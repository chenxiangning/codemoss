...
import { PersonaAvatar } from "@mossx/plugin-subagent-ui/ui";
                          ...
                          {branchDiffState.targetOnlyCommits.map((entry) => (
                            <button
                              ...
                              className={`git-history-branch-compare-commit${
                                branchDiffState.selectedDirection ===
                                  "targetOnly" &&
                    ...
                    {!branchDiffState.selectedCommitSha ? (
                      ...
                      <div className="git-history-branch-compare-detail-body">
                        ...
                        <div className="git-history-branch-compare-detail-meta">
                          <code>
                            {branchDiffState.selectedCommitDetails.sha.slice(
                              0,
                              7,
                            )}
                          </code>
                          <span>
                            {branchDiffState.selectedCommitDetails.author}
                          </span>
                          <time>
                            {new Date(
                              branchDiffState.selectedCommitDetails.commitTime *
                                1000,
                            ).toLocaleString()}
                          </time>
                        </div>
                              ...
                              (file) => {
                                ...
                                return (
                                  <button
                                    ...
                                    onClick={() =>
                                      setComparePreviewFileKey(fileKey)
                                    }
