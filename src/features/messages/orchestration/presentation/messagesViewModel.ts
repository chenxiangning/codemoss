...
export function resolveVisibleMessageItems(options: {
  ...
  const filtered = canvasSourceItems.filter((item) => {
    ...
    if (
      (activeEngine === "gemini" || activeEngine === "grok" || activeEngine === "kimi" || activeEngine === "opencode" || activeEngine === "pi") &&
  ...
  const appendReasoningRuns =
    activeEngine === "claude" || activeEngine === "gemini" || activeEngine === "grok" || activeEngine === "kimi" || activeEngine === "opencode" || activeEngine === "pi";
