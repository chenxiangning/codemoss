...
describe("releaseNotesEntryFileStem", () => {
  it("keeps semver filenames stable", () => {
    expect(releaseNotesEntryFileStem("0.8.8")).toBe("0.8.8");
    expect(releaseNotesEntryFileStem("v0.8.8")).toBe("0.8.8");
  });
});
