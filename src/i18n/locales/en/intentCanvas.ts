...
const intentCanvas = {
  intentCanvas: {
    ...
    manager: {
      ...
      title: "Intent Canvas",
      countSubtitle: "{{count}} canvas(es) · by update time",
      eraWeek: "This week",
      eraStale: "Earlier",
      eraAggregate: "{{count}} canvases · {{elements}} elements",
      eraStaleAggregate: "{{count}} canvases · idle {{days}}d",
      eraCleanupHint: "Cleanup suggested",
      selectEra: "Select this group",
      staleAnchorsBroken: "Broken anchors",
      staleEmpty: "Empty",
      staleInactive: "Idle {{days}}d",
