  ...
  settings: {
    ...
    vendor: {
      ...
      piAuth: {
        ...
        oauthDesc: {
          claude: "Anthropic subscription · third-party usage is metered per token via extra usage",
          codex: "OpenAI subscription · requires a ChatGPT Plus or Pro plan",
          copilot: "Works with github.com and GitHub Enterprise Server domains",
          xai: "Subscription auth · XAI_API_KEY also available below",
          openrouter: "PKCE sign-in mints a user-controlled API key billed from OpenRouter credits",
          radius: "Dynamic pi-messages gateway · catalog refreshes independently and is cached"
        },
        ...
        envActiveHint: "An environment variable is active (inherited by pi when mossx launches it). Set an auth.json credential to override.",
        setKey: "Set key",
        ...
        keyPlaceholderNew: "Paste {{env}}, e.g. sk-…",
        keyPlaceholderKeep: "{{mask}} (leave empty to keep)",
        toggleKeyVisibility: "Show / hide",
        advancedTipPrefix: "Advanced: keys support ",
        advancedTipMiddle: " to run secret tools (e.g. !op read 'op://vault/item') and ",
        advancedTipSuffix: " env interpolation; leave empty to keep the current credential.",
        saveHint: "Saved to ~/.pi/agent/auth.json (0600 permissions)",
        showAll: "Show all {{count}} providers",
        showLess: "Hide less-common providers",
        emptySearch: "No providers match \"{{query}}\"",
        loadFailed: "Failed to read auth state",
        resolutionOrder: "Resolution: --api-key → auth.json → env vars → models.json"
      },
    },
