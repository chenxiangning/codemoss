...
const composer = {
  composer: {
    ...
    quotaTotalRequests: "Total requests",
    quotaTotalCost: "Total spend",
    quotaInputOutput: "In / Out",
    quotaTotalTokens: "Total tokens",
    quotaAvgLatency: "Avg latency",
    quotaUsed: "Used",
    quotaReset: "Reset",
    ...
    memoryReferenceModeChoice: "Pick memory this turn or always-on auto top(n)",
    memoryReferenceOff: "Turn off memory injection",
    memoryReferenceSingleOn: "Pick memory injection this turn",
    memoryReferencePickOn: "Pick memory injection this turn",
    memoryReferenceAlwaysOn: "Always-on auto top(n) memory injection",
    ...
    memoryReferenceConfirm: "Pick memory injection this turn",
    memoryReferenceDisable: "Turn off memory injection",
