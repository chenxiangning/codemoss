...
const sidebar = {
  ...
  extensions: {
    ...
    rack: {
      ...
      marketplaceLater: "Remote Marketplace stays closed. Local marking only stages a package; it does not activate the Host or unload any code.",
      catalogTitle: "Local packages",
      catalogSubtitle: "In-repo plugin packages. Local marking only (dev aid). Host stays idle.",
      catalogPath: "Path",
