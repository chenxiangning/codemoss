...
const sidebar = {
  ...
  extensions: {
    ...
    rack: {
      title: "Plugin rack",
      subtitle: "Visual Host strip. Three plugs can be installed or uninstalled. Nine later sockets stay sealed. Marketplace stays closed.",
      ...
      marketplaceLater: "Remote Marketplace stays closed. Only Notes, Claude, and Project Map can be installed or uninstalled here. Uninstall stops the plug and keeps notes, Claude history, and project map data on disk.",
      install: "Install",
      uninstall: "Uninstall",
