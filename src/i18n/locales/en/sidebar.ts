...
const sidebar = {
  ...
  extensions: {
    ...
    rack: {
      ...
      marketplaceLater: "Remote Marketplace stays closed. Local install only stages a package and does not activate Host.",
      catalogTitle: "Local packages",
      catalogSubtitle: "In-repo plugin packages. Local staging only. Host stays idle.",
      catalogPath: "Path",
