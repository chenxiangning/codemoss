...
const sidebar = {
  ...
  extensions: {
    ...
    rack: {
      title: "插件插排",
      subtitle: "可视化 Host 插排。三根插头可安装或卸载。九个后续插座保持封口。远程市场仍关闭。",
      liveBank: "可插拔仓",
      laterBank: "只读仓",
      sealed: "封口",
      plugged: "已插入",
      ...
      state: "Host 槽位",
      generation: "代数",
      marketplaceLater: "远程 Marketplace 仍关闭。本页仅 Notes、Claude 与 Project Map 可安装或卸载。卸载停用插头，笔记、Claude history 与知识地图数据保留。",
      install: "安装",
      uninstall: "卸载",
      catalogTitle: "本地过渡仓",
