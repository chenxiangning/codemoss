...
const sidebar = {
  ...
  extensions: {
    ...
    rack: {
      title: "插件插排",
      subtitle: "可视化 Host 插排。三根插头可安装或卸载。九个后续插座保持封口。",
      liveBank: "可插拔仓",
      laterBank: "只读仓",
      sealed: "封口",
      plugged: "已插入",
      ...
      hostSupervisorLive: "Supervisor 已出进程。Host 激活仍关闭。",
      hostEnabled: "Host 已启用。",
      supervisor: "Supervisor",
      supervisorLive: "独立进程，拒绝激活",
      supervisorPid: "PID",
      supervisorPath: "套接字",
      kind: "类型",
      ownerClass: "分类",
      ...
      state: "Host 槽位",
      generation: "代数",
      marketplaceLater: "本页是本地 curated 目录。远程 Marketplace 仍关闭。仅 Notes、Claude 与 Project Map 可安装或卸载。卸载停用插头，笔记、Claude history 与知识地图数据保留。",
      install: "安装",
      uninstall: "卸载",
      catalogTitle: "本地过渡仓",
      catalogSubtitle: "仓库内分包仅供盘点。本页不提供安装或卸载。",
      catalogPath: "路径",
      catalogStatus: "状态",
      catalogNotInstalled: "未标记",
      catalogInstalled: "已标记（本地过渡仓）",
      catalogStage: "标记",
      catalogUnstage: "取消标记",
    ...
    market: {
      title: "插件市场",
      subtitle: "本地 curated 目录。三根真插头可安装或卸载。九个后续插座保持封口。远程市场仍关闭。",
      previewBanner: "当前是浏览器预览。安装态只留在本页内存。桌面端会写入 lockfile，并真实停用插头。",
      available: "可安装",
      comingSoon: "即将开放",
      installed: "已安装",
      availableBadge: "未安装",
      ...
      claudeUninstallTitle: "卸载 Claude Engine",
      claudeUninstallBody: "卸载会打断所有正在进行的 Claude 对话，并隐藏 Claude 入口。取消则保持安装。",
      claudeUninstallConfirm: "卸载并打断",
    },
    usage: {
