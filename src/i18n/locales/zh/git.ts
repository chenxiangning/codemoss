...
const git = {
  git: {
    ...
    generateCommitMessageWithConfig: "用此配置生成",
    generateCommitMessageQuick: "使用当前配置重新生成",
    generatingCommitMessage: "生成中…",
    commitMessageAvailableEngines: "可用引擎",
    ...
    historyGraphViewOptions: "提交图视图选项",
    historyGraphFirstParent: "主线",
    historyGraphFirstParentHint: "仅显示 first-parent 主脊，折叠侧枝合并层级",
    historyGraphHideNoise: "降噪",
    historyGraphHideNoiseHint: "隐藏 chore(trellis) 会话记录类噪音提交",
    ...
    historyBranchAheadTooltip: "领先上游 {{count}} 个提交",
    historyBranchBehindTooltip: "落后上游 {{count}} 个提交",
    historyBranchAheadOfTooltip: "领先 {{upstream}} {{count}} 个提交",
    historyBranchBehindOfTooltip: "落后 {{upstream}} {{count}} 个提交",
