...
const composer = {
  composer: {
    ...
    quotaReset: "重置",
    quotaProvider: "供应商",
    quotaTotalRequests: "总计请求",
    quotaTotalCost: "累计消费",
    quotaInputOutput: "输入 / 输出",
    quotaTotalTokens: "累计 Token",
    quotaAvgLatency: "平均响应",
    ...
    memoryReferenceModeChoice: "本轮挑选记忆注入或整轮开启自动 top(n) 记忆注入",
    memoryReferenceOff: "整轮关闭记忆注入",
    memoryReferenceSingleOn: "本轮挑选记忆注入",
    memoryReferencePickOn: "本轮挑选记忆注入",
    memoryReferenceAlwaysOn: "整轮开启自动top(n)记忆注入",
    ...
    memoryReferenceConfirm: "本轮挑选记忆注入",
    memoryReferenceDisable: "整轮关闭记忆注入",
