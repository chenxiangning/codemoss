...
const messages = {
  messages: {
    ...
    forkMessage: "分叉：从此处开新对话",
    rewindMessage: "回溯：回到此消息重新编辑",
    ...
    browserContextExcerptCount: "网页摘录 {{count}}",
    browserContextExcerptToggle: "展开或收起网页摘录",
    ...
    browserContextExcerptSentDetails: "发送细节",
    browserContextExcerptLocateDocument: "文档坐标",
    browserContextExcerptLocateViewport: "视口",
    browserContextExcerptLocateList: "列表",
    browserContextExcerptLocatePrevious: "上一条",
    browserContextExcerptLocateNext: "下一条",
    browserContextExcerptLocateAncestor: "所在分组",
    browserContextExcerptLocateCssPath: "路径",
    browserContextExcerptLocateElement: "元素",
    browserContextExcerptLocateSelector: "选择器",
    ...
    memoryContextSourceMemoryPick: "记忆挑选",
    memoryContextSourceUnknown: "未知来源",
    memoryInjectModePick: "本轮挑选记忆注入",
    memoryInjectModeAlways: "整轮开启自动top(n)记忆注入",
    memoryInjectSummaryLabel: "已注入 {{count}} 条项目记忆",
    memoryInjectSummaryMore: " 等 {{count}} 条",
    ...
    collapseMiddleStepsEnable: "完成后自动收起中间过程",
    collapseMiddleStepsDisable: "始终展开中间过程",
    middleStepsCollapsedHint: "已处理 · {{count}} 步",
    middleStepsProcessed: "已处理",
    middleStepsProcessedWithDuration: "已处理 {{duration}}",
    middleStepsProcessedSteps: "{{count}} 步",
