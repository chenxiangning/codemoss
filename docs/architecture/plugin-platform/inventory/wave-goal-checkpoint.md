...
| 1F2 Restricted Process framed stdio handshake | 完成 | 本刀 |
...
相对「Core + 可撤销插件平台」全文约 **99%**（合同平面 **100%**；插座本体 1F spawn+handshake 已落地；Named Pipe / Host boot 仍未做；产品拔插头仍 0%）。  
相对「产品已拔插头」约 **0%**。  
合同 100% **不等于**插座完成：Named Pipe、Host 进 boot 仍属插座本体。
