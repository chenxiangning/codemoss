...
export default defineConfig(({ command }) => ({
  ...
  resolve: {
    alias: [
      ...
      {
        find: /^@mossx\/plugin-client-documentation\/runtime$/,
        replacement: path.resolve(__dirname, "./packages/plugin-client-documentation/src/runtime.ts"),
      },
      {
        find: /^@mossx\/plugin-client-documentation\/ui$/,
        replacement: path.resolve(__dirname, "./packages/plugin-client-documentation/src/ui.ts"),
      },
      {
      ...
      {
        find: /^@mossx\/plugin-operation-facts\/runtime$/,
        replacement: path.resolve(__dirname, "./packages/plugin-operation-facts/src/runtime.ts"),
      },
      {
        find: /^@mossx\/plugin-operation-facts$/,
        replacement: path.resolve(__dirname, "./packages/plugin-operation-facts/src/index.ts"),
      },
      {
        find: /^@mossx\/plugin-about\/ui$/,
        replacement: path.resolve(__dirname, "./packages/plugin-about/src/ui.ts"),
      },
      {
        find: /^@mossx\/plugin-about$/,
        replacement: path.resolve(__dirname, "./packages/plugin-about/src/index.ts"),
      },
      {
        find: /^@mossx\/plugin-shared\/runtime$/,
        replacement: path.resolve(__dirname, "./packages/plugin-shared/src/runtime.ts"),
      },
      {
        find: /^@mossx\/plugin-shared\/ui$/,
        replacement: path.resolve(__dirname, "./packages/plugin-shared/src/ui.ts"),
      },
      {
